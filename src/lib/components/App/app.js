...
import maskClassOverrides from '../Mask/mask.overrides.css';
...
const App = props => {
    ...
    if (renderError) {
        return (
            <HeadProvider>
                ...
                <Main isMasked={true}/>
                <Mask isActive={true} classes={maskClassOverrides} />
                <ToastContainer />
            </HeadProvider>
        );
    }
    ...
    return (
        <HeadProvider>
            ...
            <Mask isActive={hasOverlay} dismiss={handleCloseDrawer} classes={maskClassOverrides}/>
            <Navigation />
            <MiniCart />
            <ToastContainer />
        </HeadProvider>
